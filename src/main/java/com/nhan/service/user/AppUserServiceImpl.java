...
import com.nhan.enums.DefaultRole;
import com.nhan.enums.TokenTypes;
import com.nhan.exception.BadRequestException;
import com.nhan.exception.NotFoundException;
import com.nhan.factory.email.SendEmailService;
import com.nhan.mapper.UserMapper;
...
import com.nhan.repository.AppUserRepository;
...
public class AppUserServiceImpl implements AppUserService {
	...
	public ResponseModelDTO register(UserRegisterDTO userRegisterDTO, HttpServletRequest request) throws MessagingException, IOException, NotFoundException {
		...
		Role role = roleRepository.findByName(DefaultRole.CUSTOMER.code)
				.orElseThrow(() -> new NotFoundException("Not found role with name: " + DefaultRole.CUSTOMER.code));
